            ...
            <div className="flex">
                ...
                <div className="profile-information flex-1 p-10">
                    <div className="orders">
                        ...
                        <p>Add your addresses for fast and easy checkout across our marketplaces</p>
                        <a><button className="hover:bg-cyan-500 hover:text-black transition">add new address</button></a>
                    </div>
