...
import img1 from "../../../puplic/assets/img25.png"
            ...
            <div className="flex">
                ...
                <div className="profile-information flex-1 p-10">
                    {/* <div className="orders">
                        ...
                        <p>We have thousands of items available across our wide range of sellers.<br /> Start ordering today!</p>
                        <a><button className="hover:bg-cyan-500 hover:text-black transition">CONTINUE SHOPPING</button></a>
                    </div> */}
